    ...
    <header className="sticky top-0 z-40 border-b border-line/60 bg-ivory/85 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-5 md:px-10">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/#services"
            className="hidden items-center justify-center rounded-full bg-rose-500 px-6 py-2.5 text-sm font-medium text-ivory transition hover:bg-rose-600 active:scale-[0.98] md:inline-flex"
          >
            Book now
          </Link>
          <MobileNav />
